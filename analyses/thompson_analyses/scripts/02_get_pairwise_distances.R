...
TARGET_WORDS <- here("analyses/thompson_analyses/data/thompson_words_with_alignments.csv")
OUTPATH <- here("analyses/thompson_analyses/data/pairwise_distances/")
...
walk(LANGS, get_dists, MODEL_PATH, target_words$english_word_form, OUTPATH)
