# get ward distance clusters for target words
...
OUT_PATH <- here("analyses/02_concreteness_semantics/data/ets/target_word_cluster_assignments_ets_ward.csv")
N_CLUSTERS <- 10
...
all_clusters <- hclust(d_clean, method = "ward.D") # ll go into one
